                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                            onTap: () {
                              print("onTap: ${rootTasks[index].toMap()}");
                    ...
                    Expanded(
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return GestureDetector(
                              onTap: () {
                                print("onTap: ${checkTasks[index].text}");
                              ...
                              onLongPress: () {
                                ...
                                context.read<ProviderBloc>().add(UpdateEvent(
                                    widget.task, checkTasks[index]));
                              },
                              onHorizontalDragStart: (DragStartDetails start) {
                                print(start);
                                ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        Container(
                          ...
                          child: FloatingActionButton.extended(
                            onPressed: () {
                              context
                                  .read<ProviderBloc>()
                                  .add(DialogEvent(false, widget.task, null));
                            },
                            extendedPadding: EdgeInsetsDirectional.only(
                                start: 30.0, end: 30.0),
                            label: Icon(Icons.add),
