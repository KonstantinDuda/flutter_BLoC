                ...
                if (changeObj == true) {
                  if (checkTask != null && rootTask != null) {
                    ...
                    context.read<CheckTaskBloc>().add(
                        CheckTaskUpdateEvent(checkTask.id, 0, newText, false));
                    context.read<ProviderBloc>().add(CheckEvent(rootTask));
                    ...
                    context.read<TaskBloc>().add(
                        RootTaskUpdateEvent(rootTask.id, 0, newText, 0, 0));
                    context.read<ProviderBloc>().add(RootEvent());
                  }
                } else {
                  if (rootTask != null) {
                    ...
                    context
                        .read<CheckTaskBloc>()
                        .add(CheckTaskAddedEvent(newText, rootTask.id));
                    context.read<TaskBloc>().add(RootTaskUpdateEvent(
                        rootTask.id, 0, rootTask.text, 0, 1));
                    context.read<ProviderBloc>().add(CheckEvent(rootTask));
                  } else {
                    print('else');
